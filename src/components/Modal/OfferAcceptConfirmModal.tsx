...
export const AcceptOfferConfirmModal = ({ data, onClose }: AcceptOfferConfirmModalProps) => {
  return (
    <div className="offer-modal">
      ...
      <div className="market-header__panel" style={{borderColor:'#6B3B3B'}}>
        <div className="market-header__toggle-row" style={{display:'grid', gridTemplateColumns:'24px 1fr', gap:'12px', alignItems:'start'}}>
          ...
          <div>
            ...
            <div className="market-header__row-note">The channel owner will transfer the owner's rights to you within 1 hour. Please ensure that you are subscribed to this channel.</div>
          </div>
        </div>
      </div>
      ...
      <div className="product-sheet__actions" style={{borderTop:0}}>
