  ...
  return (
    <div className="profile-stats">
      <div className="profile-stats__header">
        <h3 className="profile-stats__title">{t('profileStats.title')}</h3>
         <button className="profile-stats__more" onClick={() => openModal('profile-stats')}>
           <span>{t('profileStats.more')}</span>
        ...
        {mainStats.map((stat, index) => (
          <div key={index} className="profile-stats__card">
            <div className="profile-stats__card-content">
              ...
              <div className="profile-stats__card-label">{stat.name}</div>
            </div>
            <div className={`profile-stats__${stat.icon}-icon`}>
